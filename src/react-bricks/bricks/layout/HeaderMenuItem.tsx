...
import * as styles from '../../../css/HeaderMenuItem.module.css'
    ...
    <div>
          ...
          <div className={styles.containerSubmenuItemsOpen}>
            <Repeater
              ...
              renderItemWrapper={(props) => (
                <div key={props.key} onClick={() => setOpen((current) => !current)}>
                  {props}
                </div>
              )}
            />
      ...
      <div className={styles.containerSubmenuItems} role="group">
        ...
        <Repeater
          propName="submenuItems"
          renderItemWrapper={(props) => (
            <div key={props.key} onClick={() => setMobileMenuOpen(false)}>{props}</div>
          )}
        />
      </div>
    </div>
